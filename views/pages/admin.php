    <div class="row h-100 d-flex mt-1">
        <div class="col-3">
        ...
        <div class="col-6">
            <div class="card cardsH">
                <div class="card-header">
                    <span>url:</span><a id="videoLink">
                        <span id="inserturl"></span>
                    </a>
                </div>
                <div class="card-body p-0" id ="displayFrame">
            ...
            <form id="modalForm" action="" method="post">
                <div class="modal-body h-100 row">
                    ...
                    <div class="col-7" id="videoDisplay">
                        <div class="card-body p-0 h-100 d-flex flex-column" id="insertIframeHere">
